                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '*𝚂𝙸𝙽 𝙳𝙴𝚂𝙲𝚁𝙸𝙿𝙲𝙸𝙾𝙽*') :
                            ...
                            this.sendHydrated(id, text, groupMetadata.subject, apii.data, '-Bot-MD', '𝙶𝙸𝚃𝙷𝚄𝙱', null, null, [
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*[ 𝐀𝐋𝐄𝐑𝐓𝐀 ] Solo ixxi y Nymos tienen permiso*',
        owner: '*[  𝐀𝐋𝐄𝐑𝐓𝐀  ] Solo ixxi y Nymos tienen permiso*',
        mods: '*[ 𝐀𝐋𝐄𝐑𝐓𝐀  ] Solo ixxi y Nymos tienen permiso*',
        premium: '*[ 𝐀𝐋𝐄𝐑𝐓𝐀 ] 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙿𝙾𝚁 𝚄𝚂𝚄𝙰𝚁𝙸𝙾𝚂 𝙿𝚁𝙴𝙼𝙸𝚄𝙼 𝚈 𝙴𝙻/𝙻𝙰 𝙿𝚁𝙾𝙿𝙸𝙴𝚃𝙰𝚁𝙸𝙾/𝙰 (𝙾𝚆𝙽𝙴𝚁) 𝙳𝙴𝙻 𝙱𝙾𝚃*',
        group: '*[ A𝐋𝐄𝐑𝐓𝐀 ] 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙴𝙽 𝙶𝚁𝚄𝙿𝙾𝚂*',
        ...
        botAdmin: '*[  𝐀𝐋𝐄𝐑𝐓𝐀 ] NECESITO SER ADMIN, 𝙰𝙲𝙴𝙽𝙳𝙴𝚁 𝙰 𝙰𝙳𝙼𝙸𝙽 𝙴𝚂𝚃𝙴 𝙽𝚄𝙼𝙴𝚁𝙾*',
